(function () {
    ...
    */
    ...
    cpfNumbers.forEach( cpf => console.log( cleanCPF( cpf ) ) );
    ...
    */
    ...
    cpfNumbers.forEach( cpf => console.log(
    ...
    */
    ...
    var hasDoubleTag = /<\w+><\/\w+>/g;
    var text = '<div><ul><li></li><li></li><li><span></span></li></ul></div>'

    console.log( text.match( hasDoubleTag ) );
    ...
    */
    ...
    var replaceText = /<(\w+)>([^<]+)<\/\w+>/g;
    var text = '<h1>Título da página</h1><p>Este é um parágrafo</p><footer>Rodapé</footer>'

    console.log( text.replace( replaceText, '<$1>O texto dentro da tag "$1" é "$2"<$1>\n' ) )
