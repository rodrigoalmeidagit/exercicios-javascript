...
var myArray = [ 'Rodrigo', 50, function(){}, true, 'Almeida' ];
...
var newArray = [ 'Rodrigo', 10, function () { }, true, 'Almeida' ];

newArray.forEach( function( value, key ) {
    console.log( value );
})

for( var chave in newArray ) {
  console.log( newArray[ chave ]);
}
...
newArray.forEach( function( value, key ) {
    console.log( newFunction( newArray, key ) );
} );
